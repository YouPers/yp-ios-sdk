...
-(NSNumber*) postFeedbackWithCompletionBlock:(YPFeedback*) body
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/feedback", basePath];
