...
@implementation YPDiaryentriesApi
static NSString * basePath = @"http://localhost:8000";

+(YPDiaryentriesApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static YPDiaryentriesApi* singletonAPI = nil;

    if (singletonAPI == nil) {
        singletonAPI = [[YPDiaryentriesApi alloc] init];
...
-(NSNumber*) getDiaryEntryByIdWithCompletionBlock:(NSString*) _id
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/diaryentries/{id}", basePath];
    ...
    return [client dictionary:requestUrl 
                 ...
                 responseContentType:responseContentType
                     completionBlock:^(NSDictionary *data, NSError *error) {
                        ...
                        YPDiaryEntry *result = nil;
                        if (data) {
                            result = [[YPDiaryEntry alloc]initWithValues: data];
                        }
...
-(NSNumber*) getDiaryentriesWithCompletionBlock:(NSString*) sort
    ...
    NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/diaryentries", basePath];
                      ...
                      completionBlock: ^(NSDictionary *data, NSError *error) {
                         ...
                         if([data isKindOfClass:[NSArray class]]){
                             ...
                             for (NSDictionary* dict in (NSArray*)data) {
                                YPDiaryEntry* d = [[YPDiaryEntry alloc]initWithValues: dict];
                                [objs addObject:d];
                             }
