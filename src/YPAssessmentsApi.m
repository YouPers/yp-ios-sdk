#import "YPAssessmentsApi.h"
    ...
    -(NSNumber*) assessmentResultAnswerPutWithCompletionBlock:(NSString*) assessmentId
        ...
        [requestUrl replaceCharactersInRange: [requestUrl rangeOfString:[NSString stringWithFormat:@"%@%@%@", @"{", @"questionId", @"}"]] withString: [YPApiClient escape:questionId]];
        NSString* requestContentType = @"application/json";
        NSString* responseContentType = @"application/json";
    ...
    -(NSNumber*) postAssessmentQuestionWithCompletionBlock:(YPAssessmentQuestion*) body
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/assessments/{assessmentId}/questions", basePath];
