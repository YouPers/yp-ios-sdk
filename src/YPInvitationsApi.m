#import "YPInvitationsApi.h"
    ...
    -(NSNumber*) getInvitationByIdWithCompletionBlock:(NSString*) _id
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/invitations/{id}", basePath];
        ...
        return [client dictionary:requestUrl
                    ...
                    YPInvitation *result = nil;
                        if (data) {
                        result = [[YPInvitation alloc]initWithValues: data];
                        }
    ...
    -(NSNumber*) getInvitationsWithCompletionBlock:(NSString*) sort
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/invitations", basePath];
        ...
        return [client dictionary: requestUrl
            ...
            if([data isKindOfClass:[NSArray class]]){
                ...
                for (NSDictionary* dict in (NSArray*)data) {
                    YPInvitation* d = [[YPInvitation alloc]initWithValues: dict];
                [objs addObject:d];
                }
