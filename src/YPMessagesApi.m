#import "YPMessagesApi.h"
    ...
    -(NSNumber*) getMessageByIdWithCompletionBlock:(NSString*) _id
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/messages/{id}", basePath];
        ...
        return [client dictionary:requestUrl
                    ...
                    YPMessage *result = nil;
                        if (data) {
                        result = [[YPMessage alloc]initWithValues: data];
                        }
        ...
        return [client dictionary: requestUrl
            ...
            if([data isKindOfClass:[NSArray class]]){
                ...
                for (NSDictionary* dict in (NSArray*)data) {
                    YPMessage* d = [[YPMessage alloc]initWithValues: dict];
                [objs addObject:d];
                }
