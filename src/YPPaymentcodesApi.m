#import "YPPaymentcodesApi.h"
    ...
    @implementation YPPaymentcodesApi
    static NSString * basePath = @"http://localhost:8000";

    +(YPPaymentcodesApi*) apiWithHeader:(NSString*)headerValue key:(NSString*)key {
    static YPPaymentcodesApi* singletonAPI = nil;

    if (singletonAPI == nil) {
    singletonAPI = [[YPPaymentcodesApi alloc] init];
    ...
    -(NSNumber*) generatePaymentCodeWithCompletionBlock:(YPPaymentCode*) body
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/paymentcodes/generate", basePath];
        ...
        return [client dictionary:requestUrl
                    ...
                    YPPaymentCode *result = nil;
                        if (data) {
                        result = [[YPPaymentCode alloc]initWithValues: data];
                        }
    ...
    -(NSNumber*) getPaymentCodesWithCompletionBlock:(NSString*) sort
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/paymentcodes", basePath];
        ...
        return [client dictionary: requestUrl
            ...
            if([data isKindOfClass:[NSArray class]]){
                ...
                for (NSDictionary* dict in (NSArray*)data) {
                    YPPaymentCode* d = [[YPPaymentCode alloc]initWithValues: dict];
                [objs addObject:d];
                }
    ...
    -(NSNumber*) validatePaymentCodeWithCompletionBlock:(NSString*) body
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/paymentcodes/validate", basePath];
    ...
    -(NSNumber*) redeemPaymentCodeWithCompletionBlock:(NSString*) body
        ...
        NSMutableString* requestUrl = [NSMutableString stringWithFormat:@"%@/paymentcodes/redeem", basePath];
